...
# 
# Last Modified: Tuesday August 22nd 2023 10:55:27 am
# 
...
class DegSRModel(BaseModel):
    def __init__(self, opt):
        ...
        self.network_names = ["netDeg", "netSR", "netD", "netSR_ema"]
        self.networks = {}
    ...
    def forward(self):
        ...
        self.deg_outs = self.netDeg(self.gt)
    ...
    def get_current_visuals(self, need_GT=True):
        ...
        if hasattr(self, "deg"):
            out_dict["deg"] = self.deg.detach()[0].float().cpu()
        return out_dict
